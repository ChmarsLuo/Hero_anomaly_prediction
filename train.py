...
parser.add_argument('--dataset', default='hero', type=str, help='The name of the dataset to train.')
...
parser.add_argument('--show_flow', default=True, action='store_true',
...
if train_cfg.flownet == '2sd':
    flow_net = FlowNet2SD()
    flow_net.load_state_dict(torch.load('./model/liteFlownet/FlowNet2-SD.pth')['state_dict'])
else:
